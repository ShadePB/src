 ...
 * should be added to the {@link sk.action.Ability#ALL_ABILITIES} map.
 * 
 * @author Strikeskids
 * 
 */
public interface Ability {
	 ...
	 * @see sk.action.Ability#isVisible()
	 */
	...
	/**
	 * Gets the {@link org.powerbot.game.api.wrappers.widget.WidgetChild} that corresponds to this ability in its typical location
	 * 
	...
	/**
	 * A {@link java.util.HashMap} from all the ability ids to their corresponding ability
	 */
