...
public enum BookAbility implements Ability {
	...
	/**
	 * Gets the {@link sk.action.book.AbilityType} of this ability (basic, threshold, ultimate)
	 * 
	 ...
	 * @see sk.action.book.BookAbility#getStyle()
	 */
	 ...
	 * @see sk.action.book.BookAbility#available()
