 ...
 * 
 * Note: The {@link sk.action.book.magic.Spell#LUNAR_TROLLHEIM_TELEPORT} and {@link sk.action.book.magic.Spell#STANDARD_TROLLHEIM_TELEPORT} refer to the
...
public enum Spell implements Ability {
	...
	/**
	 * Gets the required {@link sk.action.book.magic.Rune}s for this spell to be cast
	 * 
