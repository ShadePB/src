...
public enum Spellbook {
	...
	/**
	 * The Spellbook used for a {@link sk.action.book.magic.Spell} that can be cast with any spellbook
	 */
	NONE(-1) {
		@Override
	 ...
	 * 
	 * @return The Spellbook that is currently open or {@link sk.action.book.magic.Spellbook#NONE} if no such spellbook exists
	 */
