...
public class Magic {
        ...
        public static enum Spell {
                /*MODERN*/
                HOME_TELEPORT(Book.MODERN, 24, 0, 0),
        ...
        public static boolean castSpell(final int spell) {
                if (Tabs.ABILITY_BOOK.open(true)) {
         ...
         *
         * @param lodestone The Lodestone to teleport to.
         * @return <tt>true</tt> if the spell was clicked; otherwise <tt>false</tt>.
         */
        ...
        public boolean autoCastSpell(final int spell) {
                if (Settings.get(43) != 4 && Tabs.ABILITY_BOOK.isOpen()) {
                        final Widget inter = getInterface();
                        if (inter != null) {
                                final WidgetChild comp = inter.getChild(spell);
        ...
        public boolean castSpellOn(final Object entity, final int spell) {
                ...
                if (castSpell(spell)) {
                        if (entity instanceof org.powerbot.game.api.wrappers.interactive.Character) {
                                return ((org.powerbot.game.api.wrappers.interactive.Character) entity).interact("Cast");
